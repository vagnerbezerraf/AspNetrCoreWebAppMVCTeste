...
namespace AspNetrCoreWebAppMVCTeste.Controllers
{
    public class EnderecoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnderecoId,Cep,Logradouro,Numero,Complemento,Bairro,Cidade,UF")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnderecoId,Cep,Logradouro,Numero,Complemento,Bairro,Cidade,UF")] Endereco endereco)
        {
